...
const STATE_TIMEZONE_MAP: Record<string, string> = {
  ...
  "NEW HAMPSHIRE": "America/New_York", "NEW JERSEY": "America/New_York", "NEW YORK": "America/New_York", "NORTH CAROLINA": "America/New_York", "OHIO": "America/New_York",
  "PENNSYLVANIA": "America/New_York", "RHODE ISLAND": "America/New_York", "SOUTH CAROLINA": "America/New_York", "VERMONT": "America/New_York", "VIRGINIA": "America/New_York", "WEST VIRGINIA": "America/New_York",
...
const AREA_CODE_TZ_MAP: Record<string, string> = {
  // Pacific
  "206": "America/Los_Angeles", "253": "America/Los_Angeles", "360": "America/Los_Angeles", "425": "America/Los_Angeles", "509": "America/Los_Angeles",
  "503": "America/Los_Angeles", "971": "America/Los_Angeles", "209": "America/Los_Angeles", "213": "America/Los_Angeles", "310": "America/Los_Angeles",
  "323": "America/Los_Angeles", "408": "America/Los_Angeles", "415": "America/Los_Angeles", "510": "America/Los_Angeles", "530": "America/Los_Angeles",
  "559": "America/Los_Angeles", "562": "America/Los_Angeles", "619": "America/Los_Angeles", "626": "America/Los_Angeles", "650": "America/Los_Angeles",
  "661": "America/Los_Angeles", "707": "America/Los_Angeles", "714": "America/Los_Angeles", "760": "America/Los_Angeles", "805": "America/Los_Angeles",
  "818": "America/Los_Angeles", "831": "America/Los_Angeles", "858": "America/Los_Angeles", "909": "America/Los_Angeles", "916": "America/Los_Angeles",
  "925": "America/Los_Angeles", "949": "America/Los_Angeles", "951": "America/Los_Angeles", "702": "America/Los_Angeles", "775": "America/Los_Angeles",

  // Mountain
  "208": "America/Denver", "307": "America/Denver", "406": "America/Denver", "435": "America/Denver",
  "801": "America/Denver", "385": "America/Denver", "970": "America/Denver", "303": "America/Denver", "720": "America/Denver",
  ...
  // Central
  "205": "America/Chicago", "256": "America/Chicago", "334": "America/Chicago", "479": "America/Chicago", "501": "America/Chicago",
  "312": "America/Chicago", "773": "America/Chicago", "847": "America/Chicago", "630": "America/Chicago", "815": "America/Chicago",
  "309": "America/Chicago", "217": "America/Chicago", "618": "America/Chicago", "319": "America/Chicago", "515": "America/Chicago",
  "316": "America/Chicago", "785": "America/Chicago", "504": "America/Chicago", "225": "America/Chicago", "318": "America/Chicago",
  "612": "America/Chicago", "651": "America/Chicago", "952": "America/Chicago", "763": "America/Chicago", "218": "America/Chicago",
  "601": "America/Chicago", "662": "America/Chicago", "314": "America/Chicago", "816": "America/Chicago", "417": "America/Chicago",
  "402": "America/Chicago", "308": "America/Chicago", "701": "America/Chicago", "405": "America/Chicago", "918": "America/Chicago",
  "605": "America/Chicago", "901": "America/Chicago", "615": "America/Chicago", "865": "America/Chicago", "423": "America/Chicago",
  "512": "America/Chicago", "214": "America/Chicago", "972": "America/Chicago", "469": "America/Chicago", "713": "America/Chicago",
  "281": "America/Chicago", "832": "America/Chicago", "210": "America/Chicago", "817": "America/Chicago", "915": "America/Chicago",
  "806": "America/Chicago", "956": "America/Chicago", "262": "America/Chicago", "414": "America/Chicago", "608": "America/Chicago",
  "920": "America/Chicago", "715": "America/Chicago",
...
export class ComplianceService {
   ...
   */
  static getLeadTimezone(state?: string | null, phone?: string | null): string {
    if (state) {
   ...
   */
  static checkSendingHours(timeZone: string): boolean {
    try {
      ...
      console.error(`[Compliance Service] Timezone check failed for ${timeZone}:`, error);
   ...
   */
  static async validateOutboundMessage(
    leadId: string,
    channel: "EMAIL" | "SMS"
    ...
    if (!value) {
      return { allowed: false, reason: `Lead lacks contact details for channel ${channel}` };
    }
    ...
    if (suppressed) {
      return { allowed: false, reason: `Contact is on the suppression list (Reason: ${suppressed.reason})` };
    }

    // 2. Check consent flags
    if (company.complianceOptInRequired) {
      if (channel === "SMS" && !lead.smsOptIn) {
        return { allowed: false, reason: "Explicit SMS consent is required and not granted" };
      }
      if (channel === "EMAIL" && lead.emailOptIn === false) {
        // For email, block if they explicitly opted out (optIn is false)
        return { allowed: false, reason: "Explicit email consent was revoked (Opt-out)" };
      }
    } else {
    ...
    if (channel === "SMS") {
      ...
      if (!isWithinHours) {
        return { allowed: false, reason: `Quiet Hours active in recipient timezone (${tz}). Re-try between 8 AM and 9 PM.` };
      }
    }
   ...
   */
  static async handleInboundKeyword(
    companyId: string,
    senderContact: string,
    messageText: string,
    channel: "EMAIL" | "SMS"
  ): Promise<{ isComplianceAction: boolean; replyText?: string }> {
      ...
      for (const lead of leads) {
        await prisma.lead.update({
          ...
          data: {
            ...
            consentSource: isSms ? "SMS STOP Keyword" : "Email Unsubscribe Request",
    ...
    if (startKeywords.includes(text) && isSms) {
      ...
      return {
        isComplianceAction: true,
        replyText: "You have successfully resubscribed to SMS alerts. Standard message & data rates may apply. Reply STOP to opt out.",
      };
    }
   ...
   */
  static addEmailUnsubscribeFooter(htmlContent: string, unsubscribeUrl: string, companyName: string): string {
    const footerHtml = `
   ...
   */
  static addSmsOptOutSuffix(body: string): string {
